<nav class="navbar bg-body-tertiary fixed-top navbar-expand-lg" style="padding:0;">
  <div class="container-fluid navbar-container-holder">
    <a class="navbar-brand" href="/"><img class="img-fluid ej-tumblers-navbar-logo" src="<?php echo get_theme_file_uri().'/photos/tumbler-main-svg-edited.svg';?>"></a>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body">
        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/cart/"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" class="bi bi-cart" viewBox="0 0 16 16">
